 ...
 * custom error classes, logging, and middleware functionality.
 */
...
describe('Error Handling System', () => {
  ...
  describe('Logger Integration', () => {
    ...
    it('should log errors with proper context', () => {
      ...
      logger.error('Test error message', error, { projectId: 'proj-789' });

      expect(loggerSpy).toHaveBeenCalledWith(
        'Test error message',
        error,
        expect.objectContaining({ projectId: 'proj-789' })
      );
    });
    ...
    it('should log performance metrics', () => {
      ...
      expect(loggerSpy).toHaveBeenCalledWith(
        ...
        expect.objectContaining({ additionalInfo: 'test' })
      );
    });
